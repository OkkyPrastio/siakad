...
<body>
    <div class="container">
        ...
        <form action="" method="post">
            <div class="control">
                <!-- Tombol Tambah Guru -->
                <button class="add-btn" onclick="window.location.href='tambah_guru.php';">
            ...
            <table>
                ...
                <?php foreach ($guru as $g) : ?>
                    <tr>
                        ...
                        <td class="action">
                            <button class="edit-btn" onclick="window.location.href='ubah_guru.php?id=<?= $g['id_guru']; ?>';">✎</button>
                            <button class="delete-btn" onclick="if(confirm('Hapus data guru?')) window.location.href='hapus_guru.php?id=<?= $g['id_guru']; ?>';">✖</button>
                        </td>
                    </tr>
                    <?php $nomor++; ?>
                <?php endforeach; ?>
